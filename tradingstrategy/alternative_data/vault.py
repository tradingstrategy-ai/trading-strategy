...
#:
#: Produced by the current eth-defi vault metrics pipeline and uploaded periodically.
VAULT_JSON_BLOB_URL = "https://top-defi-vaults.tradingstrategy.ai/top_vaults_by_chain.json"

#: Default URL for the cleaned vault share price history parquet
#:
#: Generated by the vault metadata pipeline and updated periodically.
CLEANED_VAULT_PRICE_PARQUET_URL = "https://vault-protocol-metadata.tradingstrategy.ai/cleaned-vault-prices-1h.parquet"

#: Root directory for remotely downloaded vault datasets.
#:
#: Keep these downloads separate from the main general-purpose dataset cache so
#: vault metadata and vault price history can also be redirected easily in tests.
